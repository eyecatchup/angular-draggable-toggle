...
- [Simple jQuery-Plugin-only demo, disabled support for touch-enabled devices (demo-notouch.html)](http://eyecatchup.github.io/angular-draggable-toggle/demo-notouch.html)  
